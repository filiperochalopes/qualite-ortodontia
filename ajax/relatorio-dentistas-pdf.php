...
$html = '<h1> Relatório de guias não pagas <small>do dentista <span class="convenio">'.$dentista.'</span></small></h1>';
...
<tbody>
    <tr class="space"><td></td><td></td><td></td><td></td><td></td><td></td></tr>';
...
$nome_relatorio = "relatorio_DENTISTA_guias_nao_pagas_".date("d_m_Y_H_i_s"); //reset
$mes_atual = 0; //reset

if(isset($dentista_id)){
$pesquisaguias = $mydb->query("SELECT * FROM guias WHERE dentista = ".$dentista_id." AND b_pago = 0 ORDER BY datahora DESC");
}else{
